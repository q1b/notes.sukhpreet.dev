...
const props = defineProps(["editingValue"]);

const emit = defineEmits(["update:editingValue", "blur"]);

const editing = defineModel<boolean>("editingValue");
...
let editor = useEditor({
	...
	editorProps: {
		attributes: {
			class: "prose dark:prose-invert max-w-none overflow-x-auto prose-slate font-op focus:outline-none",
		},
	},
